...
/**
 * This annotation allows a user to apply an implementation class to a Lucene
 * document to manipulate it in any way the user sees fit.
 * 
 * @author John Griffin
 */
...
public @interface ClassBridge {
    ...
    /**
     * User supplied class to manipulate document in whatever mysterious ways
     * they wish to.
     */
    public Class<?> impl();
