...
public class DateTimeTest extends AbstractRDBTest implements DateTimeDomain {
    ...
    public void test() {
        ...
        // assertEquals(literals.date2,
        // session.from($(l)).where($(l.getDate2()).eq(literals.date2)).uniqueResult($(l.getDate2())));
        ...
        // assertEquals(literals.localTime,
        // session.from($(l)).where($(l.getLocalTime()).eq(literals.localTime)).uniqueResult($(l.getLocalTime())));
        // assertEquals(literals.time,
        // session.from($(l)).where($(l.getTime()).eq(literals.time)).uniqueResult($(l.getTime())));
        ...
        // assertEquals(1,
        // session.from($(l)).where($(l.getLocalTime()).eq(literals.localTime)).count());
        // assertEquals(1,
        // session.from($(l)).where($(l.getTime()).eq(literals.time)).count());
