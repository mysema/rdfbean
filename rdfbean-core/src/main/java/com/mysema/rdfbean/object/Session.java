...
/**
 * Session provides an access point for persisting and querying persisted
 * instances of mapped classes. Classes are mapped using {@link ClassMapping}
 * for types and e.g. {@link Predicate} for properties.
 * <p>
 * Session provides
 * <ul>
...
public interface Session extends ObjectRepository, Closeable {
    ...
    /**
     * Registers a parent ObjectRepository for injections from a given
     * namespace.
     * 
     * @param namespace
     *            the namespace associated with given ObjectRepository.
     * @param parent
     */
    void addParent(String namespace, ObjectRepository parent);

    /**
     * Binds mapped properties (e.g. default values) of a given object. The
     * object doesn't have to be a mapped/managed class ({@link ClassMapping})
     * itself but if it has mapped properties, those are bound.
     * 
     * @param object
     */
    ...
    /**
     * Begins a new read-write transaction with a default timeout and binds this
     * session to it.
     * 
     ...
     * 
     * @param readOnly
     *            true if this should be a read-only transaction, false if a
     *            read-write transaction
     * @param txTimeout
     *            the transaction timeout, in seconds; if &lt;= 0 then use the
     *            default timeout
     ...
     * 
     * @throws RDFBeanException
     *             if a transaction is already active or if an error occurred
    ...
    /**
     * Deletes given resources and all references to it.
     * 
     * @param resources
     */
    void delete(Class<?> clazz, ID resources);

    /**
     * Deletes given resources and all references to those.
     * 
     * @param resources
     */
    void deleteAll(Class<?> clazz, ID... resources);

    /**
     * Finds instances of a given mapped class.
     * 
     * @param clazz
     *            mapped class of instances to be returned.
     ...
     * 
     * @param clazz
     *            class of instances requested.
     * @param clazzUri
     *            local id of rdf:type of instances requested.
     * @return
     */
     ...
     *            class of instances requested.
     * @param clazzUri
     *            rdf:type of instances requested.
     * @return
     */
    ...
    /**
     * Returns a bean of type clazz with the given natural id (URI or blank
     * node) or null if not found.
     * 
     * @param clazz
     *            type of queried object.
     * @param subject
     *            ID of queried object.
    ...
    /**
     * Returns a bean of type clazz with the given local id or null if not
     * found.
     * 
     * @param clazz
     *            type of queried object.
     * @param subject
     *            locla id of queried object.
     * @return object with given id or null if not found.
     */
    @Nullable
    ...
    /**
     * A shortcut for getting identified object with given local id. See
     * get(Class,LID).
     * 
     * @param id
     *            Local id of queried object.
     * @param clazz
     * @return
     */
    @Nullable
    ...
    /**
     * Saves (create or update) the given instance and returns an id assigned to
     * it.
     * <p>
     * NOTE: Changes are not actually persisted until flush is called. See
     * {@link FlushMode}.
     * 
     * @param instance
