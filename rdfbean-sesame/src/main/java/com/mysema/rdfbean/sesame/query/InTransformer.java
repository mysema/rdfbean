...
public class InTransformer implements OperationTransformer{
    ...
    private ValueExpr pathInCollection(TransformerContext context,
        ...
        Expression<Object> expr = (Expression<Object>)arg1;
        ...
        for (Object elem : collection){
            bo.or(ExpressionUtils.eqConst(expr, elem));
        }               
    ...
    private ValueExpr constInPath(Operation<?> operation,
            TransformerContext context, Expression<?> arg1, Expression<?> arg2) {
        ...
        if (!context.inNegation() && !context.inOptionalPath()){
            ...
            return equals.transform((Operation<?>) BooleanOperation.create(Ops.EQ_OBJECT, arg1, arg2), context);
        }
    }
